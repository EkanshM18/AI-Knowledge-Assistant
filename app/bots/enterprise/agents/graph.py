...
class EnterpriseAssistantGraph:
    ...
    def invoke(self, state: EnterpriseAgentState) -> EnterpriseAgentState:
        return self.graph.invoke(state)

    def _memory_node(self, state: EnterpriseAgentState) -> EnterpriseAgentState:
    ...
    def _router_node(self, state: EnterpriseAgentState) -> EnterpriseAgentState:
    ...
    def _synthesizer_node(self, state: EnterpriseAgentState) -> EnterpriseAgentState:
    ...
    def _validator_node(self, state: EnterpriseAgentState) -> EnterpriseAgentState:
